...
export function ProductPromotionBannerSection({ data, locale = 'en' }: ProductPromotionBannerSectionProps) {
  ...
  const heightClass = heightClasses[height as keyof typeof heightClasses] || heightClasses.medium;
    ...
    <section className="relative">
      <div className="container mx-auto w-full px-6 lg:px-24 py-20">
        ...
        >
          ...
          {/* Content */}
          <div className={cn(
            "relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-12",
            topPadding,
            bottomPadding,
            `lg:${desktopAlignment}`,
            mobileAlignment
            ...
            {subtitle && (
              <div className="mb-6">
                <RichTextRenderer
                  ...
                  className="prose prose-lg max-w-none [&_p]:text-white [&_p]:text-lg [&_p]:md:text-xl [&_p]:font-medium [&_p]:mb-0 [&_strong]:font-semibold [&_strong]:text-white"
                />
              </div>
            )}
            ...
            {description && (
              <div className="mb-8">
                <RichTextRenderer
                  ...
                  className="prose prose-base max-w-none [&_p]:text-white/90 [&_p]:text-sm [&_p]:md:text-base [&_p]:leading-relaxed [&_p]:mb-0 [&_strong]:font-semibold [&_strong]:text-white"
                />
              </div>
            )}
